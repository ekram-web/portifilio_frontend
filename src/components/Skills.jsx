...
import { motion } from 'framer-motion';
import {
  FaReact, FaNodeJs, FaDocker, FaAws, FaPython, FaJava,
  FaHtml5, FaCss3Alt, FaJs, FaGithub, FaDatabase, FaLaravel
} from 'react-icons/fa';

import {
  SiTypescript, SiMongodb, SiPostgresql, SiMysql, SiRedis, SiExpress,
  SiNextdotjs, SiDjango, SiGo, SiFirebase, SiKubernetes, SiCypress, SiJest,
  SiTestinglibrary, SiPostman, SiNetlify, SiRender, SiHostinger, SiCpanel,
  SiSqlite, SiSpring, SiFastapi, SiJquery, SiGooglecloud, SiVercel, SiChakraui
} from 'react-icons/si';
