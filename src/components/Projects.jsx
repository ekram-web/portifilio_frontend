...
const techIcons = {
  react: <svg key="react" className="w-6 h-6" viewBox="0 0 40 40" fill="none"><circle cx="20" cy="20" r="18" stroke="#61DAFB" strokeWidth="3" /><ellipse cx="20" cy="20" rx="10" ry="18" stroke="#61DAFB" strokeWidth="3" /><ellipse cx="20" cy="20" rx="18" ry="10" stroke="#61DAFB" strokeWidth="3" /><circle cx="20" cy="20" r="3" fill="#61DAFB" /></svg>,
  node: <svg key="node" className="w-6 h-6" viewBox="0 0 40 40" fill="none"><polygon points="20,5 35,13 35,27 20,35 5,27 5,13" fill="#3C873A" /></svg>,
  javascript: <svg key="javascript" className="w-6 h-6" viewBox="0 0 40 40" fill="none"><rect x="8" y="8" width="24" height="24" rx="4" fill="#F7DF1E" /><path d="M16 20l2-2 2 2 2-2" stroke="#000" strokeWidth="2" /></svg>,
  html: <svg key="html" className="w-6 h-6" viewBox="0 0 40 40" fill="none"><path d="M8 8l4 4 4-4 4 4 4-4" stroke="#E34F26" strokeWidth="3" strokeLinecap="round" /></svg>,
  css: <svg key="css" className="w-6 h-6" viewBox="0 0 40 40" fill="none"><path d="M10 10l10 10 10-10" stroke="#1572B6" strokeWidth="3" strokeLinecap="round" /></svg>,
  firebase: <svg key="firebase" className="w-6 h-6" viewBox="0 0 40 40" fill="none"><path d="M20 8l12 8-4 16-8-4-8 4-4-16z" fill="#FFCA28" stroke="#F57C00" strokeWidth="2" /></svg>,
  vercel: <svg key="vercel" className="w-6 h-6" viewBox="0 0 40 40" fill="none"><path d="M20 8l12 12H8z" fill="#000000" /></svg>,
  netlify: <svg key="netlify" className="w-6 h-6" viewBox="0 0 40 40" fill="none"><path d="M8 20l12-12 12 12-12 12z" fill="#00AD9F" /></svg>
};
...
export default function Projects() {
  return (
    <section id="projects" className="w-full py-20 bg-gradient-to-b from-[#1a1a2e] to-[#232526]">
                ...
                <div className="p-6">
                  ...
                  <div className="flex flex-wrap gap-3 mb-6">
                    {project.tech.map((tech, idx) => (
                      <div key={idx} className="flex items-center justify-center w-8 h-8 bg-white/10 rounded-lg">
                        {techIcons[tech]}
                      </div>
                    ))}
                  </div>
